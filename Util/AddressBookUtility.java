	  ...
	  AddressBookService addressBookService = new AddressBookService();
	    ...
	    public boolean checkExists(String firstName, List<Person> person) {
	        int flag = person.stream()
	                .anyMatch(p -> p.getFname().equalsIgnoreCase(firstName)) ? 1 : 0;
	        return flag == 1;
	    }
	    ...
	    public void sortRecords(List<Person> personList) {
	        ...
	        switch (choice) {
	            case 1:
	            	addressBookService.sortData(personList, SortOptions.NAME);
	                break;
	            case 2:
	            	addressBookService.sortData(personList, SortOptions.CITY);
	                break;
	            case 3:
	            	addressBookService.sortData(personList, SortOptions.STATE);
	                break;
	            case 4:
	            	addressBookService.sortData(personList, SortOptions.ZIP);
	                break;
	            case 5:
	                return;
	            default:
